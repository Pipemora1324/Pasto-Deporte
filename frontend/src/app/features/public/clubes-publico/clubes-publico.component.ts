...
@Component({
  selector: 'app-clubes-publico',
  standalone: true,
  imports: [
    CommonModule, RouterModule, FormsModule, MatInputModule, MatFormFieldModule,
    MatButtonModule, MatIconModule, MatProgressSpinnerModule,
    MatChipsModule, NavbarComponent, ClubCardComponent
  ],
  templateUrl: './clubes-publico.component.html',
  styleUrls: ['./clubes-publico.component.scss']
})
export class ClubesPublicoComponent implements OnInit {
  ...
  hayFiltros(): boolean { return !!this.searchNombre; }
}
